    ...
    <div class="col-md-12">
        <div class="white-box printableArea">
            <div class="row">
                ...
                <hr>
                <?php if ($lists == 0) { 
                    echo form_open('print-coupon/'.$this->uri->segment(2));?>
                
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">No. Coupon</label>
                                <input type="number" id="barcode" required=""  name="barcode" class="form-control" placeholder="No. Coupon"> 
                            </div>
                        </div>
                    ...
                    <?php echo form_close(); } else { ?>
                        <div class="col-md-12"id="printview">
                            <?php $code =base64_decode(urldecode($this->uri->segment(2))); for($i=0;$i<$lists;$i++){ ?>
                            <div class="cpn">
    ...
    <script>
        $(document).ready(function () {
            $("#print").click(function () {
                ...
                setTimeout(function () {
                    location.assign('<?php echo site_url('list-coupon') ?>');
                }, 1000);
            });
