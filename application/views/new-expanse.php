        ...
        <div class="panel panel-info">
            ...
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                    <?php echo form_open('new-expense'); ?> 
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="amount" required="" id="amount"  class="form-control"  placeholder="Expense Amount"> </div>
                            </div>
                            <div class="form-group">
                                <label>Date</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calender"></i></span> 
                                    <input type="date" name="date" required=""  class="form-control" placeholder="dd-mm-yyyy">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea type="text" rows="5" name="description"  class="form-control" placeholder="Expense Description"></textarea>
                                </div>
                            </div>
                        </div>  
