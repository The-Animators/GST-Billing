                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <div class="text-right" ><?php if(!$this->input->post('tomonth')){$mo=date('m');}else{$mo=$this->input->post('tomonth');} $vr=count($ilists)-1; $edndate=cal_days_in_month(CAL_GREGORIAN,$mo,date('Y',  strtotime($ilists[0]->date))).'-'.date('M-Y',  strtotime(date('Y-'.$mo.'-d'))); echo $edndate;?></div></th>
                                 </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <td>SALES</td>
                                    <td class="font-500  text-right"> <i class="fa fa-rupee"></i> <?php $ctotal=0; if($lists['sales']>0){  $ctotal+=$lists['sales']; echo round($lists['sales']); }else{ echo 0;}?></td>
                                
                                </tr>
                                 <tr>
                                    <td>PURCHASE</td>
                                    <td class="font-500  text-right"> <i class="fa fa-rupee"></i> <?php  if($lists['purchase']>0){ $total+=$lists['purchase']; echo round($lists['purchase']); }else{ echo 0;}?></td>
                                <td>CLOSING STOCK</td>
                                    <td class="font-500  text-right"> <i class="fa fa-rupee"></i> <?php if($lists['stock']>0){  $ctotal+=$lists['stock']; echo round($lists['stock']); }else{ echo 0;}?></td>
                                 ...
                                 <tr>
                                     <td class="font-500 text-right" colspan="2"><h4 style="display: inline"> Total :: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h4><b><u><i class="fa fa-rupee"></i>  <?php echo round($val+$total);?></u></b></td>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        <table class="table table-bordered">
                            ...
                            <div class="text-right" >01-<?php echo date('M-Y',  strtotime($ilists[0]->date))?></div></th>
                                    <th class="text-center" colspan="2"><h3>INCOME</h3>
                        <div class="text-right" ><?php $vr=count($ilists)-1; echo $edndate;?></div></th>
                                 </tr>
                            </thead>
                            <tbody>
                                <tr>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="text-right" ><?php echo $edndate;?></div></th>
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo $edndate;$clbal=$lists['accrbalacne']-$lists['acdrbalacne'];$opbal=$ilists[0]->acopbal-$ilists[0]->loanopbal; ?> : <?php $prf=$clbal-$opbal; if($prf<0){echo 'TRS-WITHHROWAL A/C';}else{echo 'TRS-DEPOSIT A/C';} ?></td>
                               ...
                               <tr>
                                ...
                                <tr>
                                     ...
                                     <td >&nbsp;</td>
                                     <td class="font-500  text-right">&nbsp;</td>                              
                                </tr>
                                 <tr>
                                     <td class="font-500 text-right" colspan="2"><h4 style="display: inline"> Grand Total :: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h4><b><u><i class="fa fa-rupee"></i>  <?php echo $clbal+$cashac;?></u></b></td>
