                ...
                <div class="row">
                    <div class="form-body">                       
                        <div class="col-sm-12">
                            <div class=" col-md-12 hidden">
                                <div class="col-md-8"> <h3 class="box-title m-b-0">New Refund</h3> </div>
                    ...
                    <div class="text-right">
                        <div class="row">
                            ...
                            <button type="button" id="submitRefund" class="btn btn-success waves-effect waves-light m-r-10">Submit</button>                     
                        </div>
                    </div>
                </div>
            </form>
    ...
    $("#submitRefund").click(function () {       
        ...
        $.ajax({
            ...
            success: function (result) {    
                setTimeout(function () {
                    location.assign(gurl + 'refund-list');
               }, 1000);
            },
