                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Tel/Mo. No</label>
                                        <div class="col-md-9">
                                            <input type="text" name="mobile" data-mask="0999 9999 999"  class="form-control" placeholder="Tel / Mobile No "></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Advance Payment</label>
                                        <div class="col-md-9">
                                            <input type="number" name="advance"  value="0" class="form-control" placeholder="Advance Payment"></div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="gstin"   class="form-control" placeholder="GSTIN"></div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea rows="4" name="address2"  class="form-control" placeholder="Address"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
