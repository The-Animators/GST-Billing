            ...
            <div class="row">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                if(!empty($total_lists)){
                                    foreach ($total_lists as $list) {
                                        $i++; ?>
                                    <tr>
                                        <td class="text-center"><?php echo $i  ?></td>
                                        <td class="text-center"><?php echo $list->pprodname ?></td>
                                        <td class="text-center"><?php echo $list->wstock ?></td>
                                        <td class="text-center"><?php echo $list->dstock ?></td>
                                        <td class="text-center"><?php echo $list->lstock ?></td>
                                        ...
                                        <td class="text-center"><?php echo $list->pgstper ?></td>
                ...
                <div class="col-md-12">
                    <div class="pull-right text-right"><hr>
                        <h4><b>Total Rs :</b> <?php echo $lists[0]->amttotal  ?>&nbsp;&nbsp;&nbsp;</h4>
                    </div>
